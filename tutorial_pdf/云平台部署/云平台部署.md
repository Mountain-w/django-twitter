...
>
> 代码可以通过 ftp上传到云服务器，也可以通过 git clone 到云服务器上
...
> - 现在是以DEBUG模式运行的，这被称为开发模式，如果相以生产模式运行的话，记得把 settings.py 中的DEBUG选项设为 False
...
所以可以注册一个域名，相关知识可以参考《第六章【互动】Web 基础知识》
